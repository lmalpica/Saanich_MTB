#Creating a scale bar and North Arrow ####
# need to run all of this before running 'scaleBar' function above
...
#Arrow function####
#Function to obtain the coordinates of the North arrow:
#
# Result #
#--------#
...
#Draw and customize####
#The last function enables the user to draw the elements and customize sizes
# Arguments : #
#-------------#
# lon, lat : longitude and latitude of the bottom left point of the first rectangle to draw ;
# distanceLon : length of each rectangle ;
...
scaleBar <- function(lon, lat, distanceLon, distanceLat, distanceLegend, dist.unit = "km", rec.fill = "white", rec.colour = "black", rec2.fill = "black", rec2.colour = "black", legend.colour = "black", legend.size = 3, orientation = TRUE, arrow.length = 50, arrow.distance = 50, arrow.North.size = 6){
  ...
  # Legend
  scaleBarLegend <- annotate("text", label = paste(laScaleBar$legend[,"text"], dist.unit, sep=""), x = laScaleBar$legend[,"long"], y = laScaleBar$legend[,"lat"], size = 5, colour = legend.colour)
